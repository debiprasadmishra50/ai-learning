...
print("====== LANGGRAPH ESSAY WRITED WITH GUI ======")
print(separator(count=80))
...
class writer_gui:
    ...
    def run_agent(self, start, topic, stop_after):
        ...
        # global response, ma                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         x_iterations, iterations, threads
        if start:
...
MultiAgent = ewriter(model=model, tools=[search_tool])
